...
begin
  ...
  try
    ...
    M.Lines.Text :=
      ...
      '    записи.' + LineEnding +
      '  • Имена аудиофайлов начинаются с префикса TimeRec_.' + LineEnding +
      '  • Контекстное меню списка аудио: копировать путь к файлу,' + LineEnding +
      '    открыть папку с файлом.' + LineEnding +
      '  • Статистика: текстовый вид с округлением минут до 5 ↑;' + LineEnding +
      '    «Итого» теперь считается по округлённым значениям строк.' + LineEnding +
      '  • Контекстные подсказки на полосе времени (для каждого из' + LineEnding +
      '    четырёх элементов своя) и на кнопках главного окна.' + LineEnding +
      '  • Enter в поле задачи сохраняет введённый текст, даже если' + LineEnding +
      '    в списке есть совпадение с более длинным именем.' + LineEnding +
      LineEnding +
